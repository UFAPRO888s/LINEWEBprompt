      ...
      <div className="py-4">
        <div className="flex-col items-center justify-between md:flex-row">
          ...
          <div className="flex justify-end gap-4">
            <div className="text-md rounded-md bg-gray-900 px-4 py-2 font-semibold text-white">
              สร้างกลุ่มใหม่
            </div>
            <div className="text-md rounded-md bg-gray-900 px-4 py-2 font-semibold text-white">
              ตั้งค่า
                ...
                <div>
                  <div className="-mt-px flex divide-x divide-gray-200">
                    <div className="flex w-0 flex-1 items-center px-4 py-2">
                      ...
                      <span className="text-md ml-3 flex items-center gap-1 font-bold">
                        {DDGroup.memberMids}
                        <p className="ml-2 text-start text-xs font-bold text-gray-500">
                          ID
                        </p>
                      </span>
                    </div>
                    <div className="-ml-px flex w-0 flex-1 items-center px-4 py-2">
                      ...
                      {DDGroup.inviteeMids && DDGroup.inviteeMids ? (
                        <span className="text-md ml-3 flex items-center gap-1 font-bold">
                          {DDGroup.inviteeMids}
                          <p className="ml-2 text-start text-xs font-bold text-gray-500">
                            {" "}
